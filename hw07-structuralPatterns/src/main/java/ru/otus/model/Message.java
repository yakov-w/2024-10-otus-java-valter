...
public class Message {
    ...
    public class Snapshot {
        ...
        public Snapshot(Message mes,
                        ObjectForMessage objectForMessage) {
            this.mes = mes;
            this.data = Objects.nonNull(objectForMessage) && Objects.nonNull(objectForMessage.getData()) ? List.copyOf(objectForMessage.getData()) : new ArrayList<>();
        }

        public Message restore() {
            mes.field13.getData().clear();
            mes.field13.getData().addAll(data);
            return mes;
        }
    }

    public Snapshot save() {
        return new Snapshot(this, field13);
    }
}
